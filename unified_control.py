...
╔══════════════════════════════════════════════════════════════════════════════╗
║                                                                              ║
║                    Tunisia Intelligence Unified Control                      ║
║                                                                              ║
║    🎛️  Centralized Pipeline Management and Orchestration System             ║
║                                                                              ║
║    Modules:                                                                  ║
║    • RSS Extraction & Loading Pipeline                                      ║
║    • Facebook Extraction & Loading Pipeline                                 ║
║    • AI Enrichment Processing Pipeline                                      ║
║    • Vectorization Processing Pipeline                                      ║
    ...
    try:
        ...
        if control_settings.ai_enrichment.enabled:
            ...
            if response.status_code == 200:
                print("✅ Ollama server connectivity verified")
            else:
...
def show_quick_status():
    ...
    try:
        ...
        print(f"\nMonitoring: {'✅ Active' if monitor else '❌ Inactive'}")
...
Examples:
  ...
  %(prog)s --check             # Check system requirements
    ...
    if not check_system_requirements():
        print("\n⚠️ System requirements not met. Use --check for details.")
    ...
    if args.start:
        print("🚀 Starting Tunisia Intelligence Unified Control System...")
        show_quick_status()
        print("\n" + "="*60 + "\n")
