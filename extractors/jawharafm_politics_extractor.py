"""
Jawhara FM (Politics category) RSS extractor
...
JAWHARAFM_POLITICS_FEED_URL = "https://www.jawharafm.net/ar/rss/showRss/88/1/4"

def extract(url: str = JAWHARAFM_POLITICS_FEED_URL) -> List[Dict[str, str]]:
    """Extract and clean entries from the Jawhara FM politics RSS feed.
    
    Args:
        url: URL of the RSS feed. Defaults to Jawhara FM politics feed.
