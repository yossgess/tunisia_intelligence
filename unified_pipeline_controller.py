...
class PipelineExecutor:
    ...
    def execute(self, **kwargs) -> PipelineMetrics:
        ...
        try:
            ...
            logger.info(f"✅ Completed {self.pipeline_name} pipeline")
            
        except Exception as e:
            self.metrics.status = PipelineStatus.FAILED
            self.metrics.errors.append(str(e))
            logger.error(f"❌ Failed {self.pipeline_name} pipeline: {e}")
...
class UnifiedPipelineController:
    ...
    def __init__(self):
        ...
        logger.info("🎛️ Unified Pipeline Controller initialized")
    ...
    def start(self):
        ...
        logger.info("🚀 Starting Tunisia Intelligence Unified Pipeline Controller")
    ...
    def _run_sequential_mode(self):
        ...
        while self.running:
            ...
            try:
                ...
                logger.info(f"🔄 Starting processing cycle {self.current_cycle}")
                ...
                for pipeline_name in pipeline_order:
                    ...
                    if self.control_settings.is_pipeline_enabled(pipeline_name):
                        ...
                        if self.control_settings.scheduling.pipeline_delay_minutes > 0:
                            ...
                            logger.info(f"⏳ Waiting {delay_seconds}s before next pipeline")
    ...
    def _report_cycle_completion(self, cycle_num: int, duration: float, cycle_metrics: Dict[str, PipelineMetrics]):
        ...
        logger.info(f"🎯 Cycle {cycle_num} completed in {duration:.1f}s")
    ...
    def pause(self):
        ...
        self.paused = True
        logger.info("⏸️ Pipeline controller paused")
    
    def resume(self):
        """Resume pipeline execution."""
        self.paused = False
        logger.info("▶️ Pipeline controller resumed")
    ...
    def execute_single_pipeline(self, pipeline_name: str) -> PipelineMetrics:
        ...
        logger.info(f"🎯 Manual execution of {pipeline_name} pipeline")
